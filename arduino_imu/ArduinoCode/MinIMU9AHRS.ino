...
// LSM303 accelerometer:  g sensitivity
// 1 mg/digit; 1 g = 1000
#define GRAVITY 1000  //this equivalent to 1G in the raw data coming from the accelerometer 

#define ToRad(x) ((x)*0.01745329252)  // *pi/180
#define ToDeg(x) ((x)*57.2957795131)  // *180/pi
#define ToMss(x) ((x)*9.81/GRAVITY)
